  ...
  return (
    <>
      ...
      <div className="container neushadow">
        ...
        shadow. You can see this technique used today in everything from blockbuster movies to independent vlogs. Using
        this combination creates an glowing effect when used with a darker background.
      </div>
    </>
  );
}
